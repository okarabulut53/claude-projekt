...
export function HeroVisual({ children }: { children: ReactNode }) {
  return (
    <div className="relative">
      ...
      <div className="absolute -top-6 -right-5 z-20 flex items-center gap-2.5 rounded-2xl border border-brand-border bg-surface px-3.5 py-2.5 shadow-md">
      ...
      <div className="absolute -bottom-6 left-6 z-20 flex translate-y-full items-center gap-2.5 rounded-2xl border border-brand-border bg-surface px-3.5 py-2.5 shadow-md">
        ...
        <div>
          ...
          <div className="text-sm font-bold leading-tight text-foreground">Aktien · ETFs · Krypto</div>
        </div>
      </div>
    </div>
  );
